...
* Outputs :  method_disagreements_all.tif ( graph comparing the differences in the methods in three pairs: typewriter vs. genefinder, genefinder vs mykrobe, and mykrobe vs typewriter
